exports.itemDetail = 'select * form basket a , books b on a.book_uid = b.book_uid '
exports.basketDetail = 'select * from basket where users_user_id=? order by basket_date'
exports.addBasket = 'insert into baskets(basket_uid, basket_date, users_user_uid) values(?, ?, ?)'
